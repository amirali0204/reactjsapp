...
class Kanban extends React.PureComponent<{}&any, IKanbanProps&any> {
    ...
    constructor(props: {}) {
        ...
        const source = {
            ...
            dataType: 'array',
            localData: [
                { id: '1161', state: 'new', label: 'Combine Orders', tags: 'orders, combine', hex: '#fff', resourceId: 3 },
                { id: '1645', state: 'work', label: 'Change Billing Address', tags: 'billing', hex: '#fff', resourceId: 1 },
                { id: '9213', state: 'new', label: 'One item added to the cart', tags: 'cart', hex: '#fff', resourceId: 3 },
                { id: '6546', state: 'done', label: 'Edit Item Price', tags: 'price, edit', hex: '#fff', resourceId: 4 },
                { id: '9034', state: 'new', label: 'Login 404 issue', tags: 'issue, login', hex: '#fff' }
            ]
        };
        ...
        this.state = {
            columnRenderer,
            columns: [
                { text: 'Backlog', iconClassName: getIconClassName(), dataField: 'new', maxItems: 14 },
                { text: 'In Progress', iconClassName: getIconClassName(), dataField: 'work', maxItems: 12 },
                { text: 'Done', iconClassName: getIconClassName(), dataField: 'done', maxItems: 15 }
            ],
            itemRenderer,
    ...
    public render() {
        return (
            <div id = "abbss">
            <JqxKanban ref={this.myKanban} theme={'bootstrap'}
                ...
                resources={this.state.resources} columnRenderer={this.state.columnRenderer} height={window.innerHeight-180}
