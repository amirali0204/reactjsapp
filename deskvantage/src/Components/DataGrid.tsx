...
import {dvGridColumns,dvGridDataFields} from "../Components/ComponentData/GridList/index"
    ...
    public render() {
        return (
            ...
            onSort={this.myGridOnSort} filterable={true} autoshowcolumnsmenubutton={true}
                width={'100%'} height={window.innerHeight-205} ref={this.myGrid}
                ...
                source={this.state.source} columns={this.state.columns} columnsresize={true} > 
                    ...
                    height={window.innerHeight-205} resizable={false} draggable={false}
