...
class DVBarChart extends React.PureComponent<{}, IChartProps> {
            ...
            seriesGroups: [
                {
                    ...
                    series: [
                        { dataField: 'Population', displayText: 'Population ()', toolTipFormatSettings: { thousandsSeparator: ',' } }
                    ],                   
                    type: 'column'                 
                }
            ],
    ...
    public render() {
        return (
            <JqxChart ref={this.myChart} style={{ width: '100%', height: '90%' }}
                ...
                valueAxis={this.state.valueAxis} seriesGroups={this.state.seriesGroups} colorScheme={'scheme10'} />
        );
    }   
}
export default DVBarChart;